...
enum class GameEventType(val resource: Int?) {
    ...
    INSTAGRAM(R.drawable.ic_instagram), FACEBOOK(R.drawable.ic_facebook), TELEGRAM(R.drawable.ic_telegram), DISCORD(
        R.drawable.ic_discord
    ),
    SNAPCHAT(R.drawable.ic_snap), LINKEDIN(R.drawable.ic_linkedin), REDDIT(R.drawable.ic_reddit), TWITCH(
