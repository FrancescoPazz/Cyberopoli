...
val PERIMETER_CELL_CONFIGS: List<CellConfig> = listOf(
    ...
    CellConfig(2, Cell("2", CellType.REDDIT, "Reddit", "Bonus casuale","",  7)),
    CellConfig(3, Cell("3", CellType.TIKTOK, "TikTok", "Salto +2",    "",  0)),
    CellConfig(4, Cell("4", CellType.CHANCE, "Chance", "Pesca carta", "",  0)),
    CellConfig(5, Cell("5", CellType.HACKER, "Hacker", "Ruba 5",      "",  0)),
    CellConfig(9, Cell("9", CellType.CHANCE, "Chance", "Pesca carta", "",  0)),
    CellConfig(10, Cell("10", CellType.HACKER, "Hacker", "Ruba 5",      "",  0)),
    CellConfig(14, Cell("14", CellType.HACKER, "Hacker", "Ruba 5",      "",  0)),
    CellConfig(15, Cell("15", CellType.CHANCE, "Chance", "Pesca carta", "",  0)),
    CellConfig(19, Cell("19", CellType.REDDIT, "Reddit", "Bonus casuale","",  7)),
    CellConfig(20, Cell("20", CellType.YOUTUBE, "YouTube", "Guadagni +10", "", 10)),
    CellConfig(21, Cell("21", CellType.HACKER, "Hacker", "Ruba 5",      "",  0)),
    CellConfig(22, Cell("22", CellType.YOUTUBE, "YouTube", "Guadagni +10", "", 10)),
    CellConfig(23, Cell("23", CellType.WHATSAPP, "WhatsApp", "Perdi 5",     "", -5)),
    CellConfig(24, Cell("24", CellType.REDDIT, "Reddit", "Bonus casuale","",  7)),
)
